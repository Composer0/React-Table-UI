...
import teamMembersData from '../models/TeamMembers'; // Import the data from the correct location
...
const TeamMembersTable = () => {
    ...
    const currentTeamMembers = teamMembersData.slice(startIndex, endIndex); // Use the imported data
